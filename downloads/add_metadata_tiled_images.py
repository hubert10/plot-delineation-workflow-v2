...
saved_grid_path = PROJECT_ROOT + "Data/grid/"
saved_tiles_path = PROJECT_ROOT + "Data/image/"
print(BASE_DIR)
...
for i in range(len(p.bounds["minx"])):
    ...
    ds = None
    input_path = PROJECT_ROOT + "Data/image/image_{}.jpg".format(i)
    output_path = PROJECT_ROOT + "Data/tile/tile_{}.tif".format(i)
    os.system(
