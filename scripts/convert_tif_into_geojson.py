...
input_raster = PROJECT_ROOT + "results/georeferenced/tile_4096_4096/tile_4096_4096.tif"
output_dir = PROJECT_ROOT + "results/refs/"
...
#         """Transforms mask into vector file(Geojson) .
...
# input_raster_path = PROJECT_ROOT + "samples/roi/Tile40964096/"
# input_raster = pathlib.Path(os.path.join(input_raster_path + roi_image))
# output_dir = input_raster_path
# Polygonized.mask_to_raster('/home/beast/Desktop/Heuristics/RS/plot-delineation-workflow-v2-2206/results/predicted/tile_4096_4096/tile_4096_4096.jpg', output_dir)
# print()