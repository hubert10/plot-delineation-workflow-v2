...
class MultiClass_Resnet34(nn.Module):
    def __init__(self, num_classes=1, num_filters=32, pretrained=True, is_deconv=False):
        ...
        self.dec1 = MultiClass_DecoderBlock(
...
class MultiClass_UNet_VGG16(nn.Module):
    def __init__(self, num_classes=1, num_filters=32, pretrained=True):
        ...
        self.center = MultiClass_DecoderBlock(512, num_filters * 8 * 2, num_filters * 8)
...
class MultiClass_UNet_VGG11(nn.Module):
    def __init__(self, num_classes=1, num_filters=32, pretrained=True):
        ...
        self.center = MultiClass_DecoderBlock(
            256 + num_filters * 8, num_filters * 8 * 2, num_filters * 8, is_deconv=True
        )
        self.dec5 = MultiClass_DecoderBlock(
            512 + num_filters * 8, num_filters * 8 * 2, num_filters * 8, is_deconv=True
        )
        self.dec4 = MultiClass_DecoderBlock(
            512 + num_filters * 8, num_filters * 8 * 2, num_filters * 4, is_deconv=True
        )
        self.dec3 = MultiClass_DecoderBlock(
            256 + num_filters * 4, num_filters * 4 * 2, num_filters * 2, is_deconv=True
        )
        self.dec2 = MultiClass_DecoderBlock(
            128 + num_filters * 2, num_filters * 2 * 2, num_filters, is_deconv=True
        )
        self.dec1 = MultiClass_ConvRelu(64 + num_filters, num_filters)
