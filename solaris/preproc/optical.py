...
class RGBToHSL(PipeSegment):
    ...
    def __init__(self, rband=0, gband=1, bband=2, rgbmax=255.0):
        super().__init__()
        self.rband = rband
        self.gband = gband
        self.bband = bband
    ...
    def transform(self, pin):
        ...
        outbands = convertarray(
            np.clip(pin.data[self.rband] / m, 0, 1),
...
class HSLToRGB(PipeSegment):
    ...
    def __init__(self, hband=0, sband=1, lband=2, rgbmax=255.0):
        super().__init__()
        self.hband = hband
        self.sband = sband
        self.lband = lband
    ...
    def transform(self, pin):
        ...
        outbands = convertarray(
            np.clip(pin.data[self.hband], 0, 1),
...
class HSVToRGB(PipeSegment):
    ...
    def __init__(self, hband=0, sband=1, vband=2, rgbmax=255.0):
        super().__init__()
        self.hband = hband
        self.sband = sband
        self.vband = vband
